...
class TestAuthenticationFlow:
    ...
    def test_first_time_setup_and_login(self, auth_manager):
        ...
        success, message = auth_manager.create_credentials("admin", "secure_password_123")
        assert success is True
        assert auth_manager.credentials_exist()

        # Step 3: Login with credentials
        success, message = auth_manager.verify_credentials("admin", "secure_password_123")
        assert success is True
    ...
    def test_password_change_workflow(self, auth_manager):
        ...
        # Change password
        success, message = auth_manager.update_credentials("user", "old_password", "new_password")
        assert success is True
