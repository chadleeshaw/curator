...
def test_extract_edition_variant_kids():
    ...
    variant = matcher._extract_edition_variant("National Geographic Kids")
    assert variant == "kids"
...
def test_extract_edition_variant_little_kids():
    ...
    matcher = TitleMatcher(threshold=80)
    variant = matcher._extract_edition_variant("National Geographic Little Kids")
...
def test_extract_edition_variant_professional():
    ...
    matcher = TitleMatcher(threshold=80)
    variant = matcher._extract_edition_variant("Forbes Professional")
...
def test_extract_edition_variant_regional_us():
    ...
    matcher = TitleMatcher(threshold=80)
    variant = matcher._extract_edition_variant("PC Gamer US")
    assert variant == "us"
...
def test_extract_edition_variant_regional_uk():
    ...
    matcher = TitleMatcher(threshold=80)
    variant = matcher._extract_edition_variant("PC Gamer UK")
    assert variant == "uk"
...
def test_extract_edition_variant_none():
    ...
    matcher = TitleMatcher(threshold=80)
    variant = matcher._extract_edition_variant("National Geographic")
...
def test_special_edition_not_detected_as_variant():
    ...
    for title in test_cases:
        variant = matcher._extract_edition_variant(title)
...
def test_context_aware_no_detection():
    ...
    variant = matcher._extract_edition_variant("Time Magazine Vol 5 No 10")
...
def test_format_indicator_not_detected():
    ...
    variant = matcher._extract_edition_variant("Wired Magazine 2024 Digital")
