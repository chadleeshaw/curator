...
def parser():
    ...
    return Parser(fuzzy_threshold=80)
...
# ==============================================================================
# Test Parser: File Parsing (Use Case 1 & 2)
# ==============================================================================


class TestParserFilesParsing:
...
# ==============================================================================
# Test Parser: Search Result Parsing (Use Case 4)
# ==============================================================================


class TestParserSearchResults:
    ...
    def test_parse_search_result_cleans_title(self, parser):
        ...
        # Act
        result = parser.parse_search_result(title=messy_title, url=url, provider=provider)
...
# ==============================================================================
# Test Parser: Download File Parsing (Use Case 3)
# ==============================================================================


class TestParserDownloadFiles:
...
# ==============================================================================
# Test Parser: Filename-Only Parsing
# ==============================================================================


class TestParserFilenameOnly:
...
class TestParserEdgeCases:
    ...
    def test_parser_with_custom_fuzzy_threshold(self):
        ...
        # Act
        parser = Parser(fuzzy_threshold=90)
