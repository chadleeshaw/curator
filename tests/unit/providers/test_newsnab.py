...
from core.factories import ProviderFactory  # noqa: E402
...
try:
    if newsnab_config:
        ...
        provider = NewsnabProvider(newsnab_config)
        assert provider.categories == "7000,7010,7020,7030,6000,8000,8010"
        ...
        assert provider_default.categories == "7000,7010,7020,7030,6000,8000,8010"
