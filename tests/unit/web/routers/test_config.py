...
class TestMaskSensitiveConfig:
    ...
    def test_mask_download_client_api_key(self):
        ...
        config = {
            "download_client": {"type": "sabnzbd", "api_url": "http://localhost:8080", "api_key": "download_secret_key"}
        }
    ...
    def test_mask_empty_api_keys(self):
        ...
        config = {
            "search_providers": [{"name": "Provider1", "api_key": "", "api_url": "http://example.com"}],
            "download_client": {"type": "sabnzbd", "api_key": ""},
        }
    ...
    def test_mask_missing_api_keys(self):
        ...
        config = {
            "search_providers": [{"name": "Provider1", "api_url": "http://example.com"}],
            "download_client": {"type": "sabnzbd"},
        }
    ...
    def test_mask_does_not_modify_original(self):
        ...
        original_config = {
            ...
            "download_client": {"type": "sabnzbd", "api_key": "original_download_key"},
        }
...
class TestDeepMerge:
    ...
    def test_update_search_provider_api_key_when_not_masked(self):
        ...
        base = {"search_providers": [{"name": "Provider1", "api_key": "old_key", "api_url": "http://example.com"}]}

        update = {
            "search_providers": [{"name": "Provider1", "api_key": "new_real_key", "api_url": "http://example.com"}]
        }
    ...
    def test_preserve_download_client_api_key_when_masked(self):
        ...
        base = {
            "download_client": {"type": "sabnzbd", "api_url": "http://localhost:8080", "api_key": "real_download_key"}
        }

        update = {"download_client": {"type": "sabnzbd", "api_url": "http://localhost:8080", "api_key": "***"}}
    ...
    def test_update_download_client_api_key_when_not_masked(self):
        ...
        base = {"download_client": {"type": "sabnzbd", "api_key": "old_key"}}

        update = {"download_client": {"type": "sabnzbd", "api_key": "new_real_key"}}
    ...
    def test_preserve_other_fields_while_updating_api_key(self):
        ...
        update = {
            "search_providers": [{"name": "NewName", "api_key": "***", "api_url": "http://new.com", "enabled": True}]
        }
    ...
    def test_add_new_provider_with_real_key(self):
        ...
        base = {"search_providers": [{"name": "Provider1", "api_key": "real_key_1", "api_url": "http://example1.com"}]}
    ...
    def test_handle_mismatched_provider_counts(self):
        ...
        update = {"search_providers": [{"name": "Provider1", "api_key": "***", "api_url": "http://example1.com"}]}
    ...
    def test_deep_merge_nested_dicts(self):
        ...
        base = {"storage": {"db_path": "/old/path", "download_dir": "/downloads"}}

        update = {"storage": {"db_path": "/new/path"}}
    ...
    def test_regression_bug_scenario(self):
        ...
        ui_update = {"search_providers": [{"name": "Provider1", "api_key": "***", "api_url": "http://api.example.com"}]}
