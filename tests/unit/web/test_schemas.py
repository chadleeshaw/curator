...
from web.schemas import SearchRequest, DownloadSingleIssueRequest, APIResponse
...
def test_download_single_issue_request_schema():
    ...
    request = DownloadSingleIssueRequest(tracking_id=1, title="Test Magazine", url="https://example.com/nzb")
...
def test_api_response_schema():
    ...
    response = APIResponse(success=True, message="Operation successful", data={"id": 123})
