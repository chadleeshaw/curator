    ...
    if (isLoginPage) {
      ...
      await Promise.all([
        page
          ...
          .catch((e) => console.log('Navigation wait timed out, continuing...')),
    ...
    if (!page.url().includes('login')) {
      ...
      if (libraryTab) {
        ...
        await page.evaluate(() => {
          ...
          const libBtn = btns.find(
            (b) => b.textContent && b.textContent.toLowerCase().includes('library')
          );
      ...
      await page.screenshot({
        path: 'docs/screenshots/desktop_library.jpg',
        type: 'jpeg',
        quality: 90,
      });
      console.log('Screenshot saved to docs/screenshots/desktop_library.jpg');
    } else {
