...
class DownloadManager:
    ...
    def submit_download(
        ...
        try:
            ...
            job_id = self.download_client.submit(
                nzb_url=search_result["url"], title=search_result["title"], category=download_category
            )
    ...
    def retry_submission(self, submission_id: int, session: Session) -> Dict[str, Any]:
        ...
        try:
            ...
            job_id = self.download_client.submit(
                nzb_url=submission.source_url, title=submission.result_title, category=download_category
            )
