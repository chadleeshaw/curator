...
export function renderGroupedView(
  ...
  if (specialEditionsData && specialEditionsData.length > 0) {
    ...
    specialTitle.innerHTML =
      '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="vertical-align:-2px;margin-right:6px"><polygon points="12 2 22 12 12 22 2 12"/></svg>Special Editions';
